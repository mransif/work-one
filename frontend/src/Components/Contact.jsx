    ...
    return (
        <div className="flex flex-col justify-between items-center min-h-screen bg-cover p-4" style={{ backgroundImage: "url(/images/mcet.jpg)" }}>
            ...
            >
                ...
                <motion.p className="text-lg" whileHover={{ scale: 1.05 }}>Address: [Insert College Address Here]</motion.p>
                <motion.p className="text-lg" whileHover={{ scale: 1.05 }}>Phone: +91 [Insert Phone Number]</motion.p>
                <motion.p className="text-lg" whileHover={{ scale: 1.05 }}>Email: info@musaliarcollege.com</motion.p>
            </motion.div>
